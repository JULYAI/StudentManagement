...
public class FindStudentByCourseFrame extends JFrame{
    /**
     * 课程标签
     */
    private JLabel lblInputCourse;
    /**
     * 课程文本框
     */
     ...
     * @param title
     */
    public FindStudentByCourseFrame(String title) {
        super(title);
        intiGUI();
    }
    ...
    private void intiGUI() {
        ...
        lblInputCourse = new JLabel("输入课程：");
        txtCourse = new JTextField(13);
        ...
        pnlNorth.add(lblInputCourse);
        pnlNorth.add(txtCourse);
        ...
        table.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                // 设置文本框内容
                txtCourse.setText(table.getValueAt(row, 0).toString());
            }
        });
    }
    ...
    private void doQuery() {
        ...
        if (!course.equals("")) {
            // 按课程查询获取学生列表
            students = studentService.findStudentsByCourse(course);
            // 填充表格
            fillTableData();
        } else {
            JOptionPane.showMessageDialog(this, "请输入待查学生课程！", "警告", JOptionPane.WARNING_MESSAGE);
