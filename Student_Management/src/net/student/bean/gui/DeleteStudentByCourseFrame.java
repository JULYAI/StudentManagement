...
public class DeleteStudentByCourseFrame extends JFrame{
    /**
     * 课程标签
     */
     ...
     * @param title
     */
    public DeleteStudentByCourseFrame(String title) {
        super(title);
        intiGUI();
    }
            ...
            public void actionPerformed(ActionEvent e) {
                if (!rows.isEmpty()) {
                    ...
                    if (choice == JOptionPane.OK_OPTION) {
                        ...
                        // 按课程删除学生
                        int count = studentService.deleteStudentsByCourse(course);
                        if (count > 0) {
